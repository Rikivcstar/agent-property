      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            exit={{ opacity: 0 }}
            onClick={onClose}
            className="fixed inset-0 z-50 bg-[#0a0908]/80 backdrop-blur-md"
          />
          ...
          <motion.div
            ...
            className="fixed z-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-lg origin-center"
          >
            <div className="bg-[#11100f] border border-[#D4AF37]/30 shadow-2xl overflow-hidden shadow-gold/5">
              {/* Header */}
